...
Public Class ownerDetailsForm
    ...
    Private Sub LoadOwnerDetails()
        ...
        SELECT 
            ...
            o.ownerAge,
            o.ownerSex,
            (SELECT COUNT(*) FROM petinformation p WHERE p.OwnerID = o.ownerID) AS petCount,  -- Count pets
            COUNT(b.bookingID) AS bookingCount
        FROM ownerinformation o
        LEFT JOIN petinformation p ON o.ownerID = p.OwnerID   -- Join owner with pets
        LEFT JOIN bookingtable b ON p.petID = b.petID          -- Join pets with bookings
            ...
            Using cmd As New MySqlCommand(query, conn)
                ...
                Using reader As MySqlDataReader = cmd.ExecuteReader()
                    If reader.Read() Then
                        ...
                        lblTotalPets.Text = "Total Pets: " & reader("petCount").ToString()   ' Display pet count
                    Else
